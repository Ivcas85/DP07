...
while True:
    ...
    # konec=input("Chceš hru ukoncit? Jestliže ano, napiš ano.")
    # if konec=="ano":
    #     break
    smer = input("Kudy se má had vydat? Zvol s pro sever, j pro jih, v pro východ a z pro západ. Pokud chceš zkončit, napiš konec.")
    if smer == "konec":
        False
        break
    while True:
